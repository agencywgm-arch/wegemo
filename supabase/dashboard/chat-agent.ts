...
// Then add the secret OPENAI_API_KEY in Edge Functions → Secrets.
// (This mirrors supabase/functions/chat-agent/index.ts with the CORS helper
//  inlined so it can be deployed without the CLI / shared module.)
// ============================================================================
